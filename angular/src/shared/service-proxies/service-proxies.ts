...
export class CollegeServiceProxy {
     ...
     * @return OK
     */
    getAll(keyword: string | undefined, skipCount: number | undefined, maxResultCount: number | undefined): Observable<CollegeDtoPagedResultDto> {
...
export class CollegeDto implements ICollegeDto {
    ...
    zaghdadString: string | undefined;
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.gpsLongitude = _data["gpsLongitude"];
            this.email = _data["email"];
            this.zaghdadString = _data["zaghdadString"];
    ...
    toJSON(data?: any) {
        ...
        data["zaghdadString"] = this.zaghdadString;
