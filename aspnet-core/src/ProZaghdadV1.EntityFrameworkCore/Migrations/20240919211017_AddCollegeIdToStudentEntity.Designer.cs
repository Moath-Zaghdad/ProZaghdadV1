...
namespace ProZaghdadV1.Migrations
{
    ...
    [Migration("20240919211017_AddCollegeIdToStudentEntity")]
    partial class AddCollegeIdToStudentEntity
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProZaghdadV1.Models.College", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<string>("ZaghdadString")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("ProZaghdadV1.Models.Student", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("ProZaghdadV1.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("ProZaghdadV1.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("ProZaghdadV1.Models.Student", b =>
                {
                    b.HasOne("ProZaghdadV1.Models.College", "College")
                        .WithMany("Students")
