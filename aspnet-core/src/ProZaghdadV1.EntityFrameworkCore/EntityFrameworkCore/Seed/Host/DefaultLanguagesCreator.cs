...
namespace ProZaghdadV1.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = ProZaghdadV1Consts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(ProZaghdadV1DbContext context)
        {
            _context = context;
        }
