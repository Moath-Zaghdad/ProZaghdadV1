...
{
    public abstract class ProZaghdadV1WebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static ProZaghdadV1WebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(ProZaghdadV1WebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<ProZaghdadV1DbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<ProZaghdadV1DbContext, Task> action)
        {
            using (var context = IocManager.Resolve<ProZaghdadV1DbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<ProZaghdadV1DbContext, Task<T>> func)
        {
            T result;
